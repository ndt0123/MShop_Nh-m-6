            ...
            if (result.length == 0) { //Kiểm tra xem id có trong cơ sở dữ liệu không
                ...
                connect_db.con.query(queryImages, function (err1, result1) {
                    ...
                    connect_db.con.query(queryRecommend, function (err2, result2) {
                        ...
                        var queryCommentLevel1 = "SELECT IDCmt, NoiDung, ThoiGian, TenNguoiDung AS TenDangNhap, Level FROM comment C INNER JOIN nguoidung A ON C.MaKhachHang=A.MaNguoiDung WHERE C.LoaiSanPham='Điện thoại' AND C.MaSanPham=" + id;
                        connect_db.con.query(queryCommentLevel1, function (err3, result3) {
                            if (err3) throw err3;
                            commentLevel1 = result3;

                            var queryCommentLevel2 = "SELECT C2.IDCmt2, C2.IDCmt, C2.NoiDung, C2.ThoiGian, A.TenNguoiDung AS TenDangNhap, A.Level FROM comment2 C2 INNER JOIN comment C1 INNER JOIN nguoidung A ON C2.IDCmt=C1.IDCmt AND C2.IDNguoiDung=A.MaNguoiDung WHERE C1.LoaiSanPham='Điện thoại' AND C1.MaSanPham=" + id;
            ...
            if (result.length == 0) { //Kiểm tra xem id có trong cơ sở dữ liệu không
                ...
                connect_db.con.query(queryImages, function (err1, result1) {
                    ...
                    connect_db.con.query(queryRecommend, function (err2, result2) {
                        ...
                        var queryCommentLevel1 = "SELECT IDCmt, NoiDung, ThoiGian, TenNguoiDung AS TenDangNhap, Level FROM comment C INNER JOIN nguoidung A ON C.MaKhachHang=A.MaNguoiDung WHERE C.LoaiSanPham='Phụ kiện' AND C.MaSanPham=" + id;
                        connect_db.con.query(queryCommentLevel1, function (err3, result3) {
                            if (err3) throw err3;
                            commentLevel1 = result3;

                            var queryCommentLevel2 = "SELECT C2.IDCmt2, C2.IDCmt, C2.NoiDung, C2.ThoiGian, A.TenNguoiDung AS TenDangNhap, A.Level FROM comment2 C2 INNER JOIN comment C1 INNER JOIN nguoidung A ON C2.IDCmt=C1.IDCmt AND C1.MaKhachHang=A.MaNguoiDung WHERE C1.LoaiSanPham='Phụ kiện' AND C1.MaSanPham=" + id;
                            connect_db.con.query(queryCommentLevel2, function (err4, result4) {
                                if (err4) throw err4;
                                commentLevel2 = result4;
