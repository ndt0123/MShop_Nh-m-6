            ...
            <div className="col-xs-12 payment-products">
                <div className="col-xs-12 detail" style={{ padding: "0px" }}>
                    <div className="col-xs-3 img">
                        <img className="col-xs-12" src={'http://localhost:5000/accessories/' + this.state.detail.hinhAnh} style={{ padding: "0px" }} />
                    </div>
    ...
    render() {
        return (
            <div className="col-xs-12 payment-products">
                <div className="col-xs-12 detail" style={{ padding: "0px" }}>
                    <div className="col-xs-3 img">
                        <img className="col-xs-12" src={'http://localhost:5000/phones/' + this.state.detail.hinhAnh} style={{ padding: "0px" }} />
                    </div>
                                ...
                                <div className="col-xs-3 img">
                                    {
                                        note.LoaiSanPham === 'Điện thoại' ?
                                            <img className="col-xs-12" src={'http://localhost:5000/phones/' + note.DuongDan} style={{ padding: "0px" }} />
                                            : note.LoaiSanPham === 'Phụ kiện' ?
                                                <img className="col-xs-12" src={'http://localhost:5000/accessories/' + note.DuongDan} style={{ padding: "0px" }} />
                                                : ""
                                    }                                    
                                </div>
