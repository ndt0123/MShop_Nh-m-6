                            ...
                            return (
                                index === 0 ?
                                    <div className="item active" key={index}>
                                        {
                                            window.location.pathname === '/chi-tiet/dien-thoai' ?
                                                <img src={'http://localhost:5000/phones/' + note.DuongDan} alt="" />
                                                :
                                                <img src={'http://localhost:5000/accessories/' + note.DuongDan} alt="" />
                                        }                                        
                                    </div> :
